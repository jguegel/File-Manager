...
class FavoritesFragment(context: Context, attributeSet: AttributeSet) : MyViewPagerFragment<MyViewPagerFragment.FavoriteInnerBinding>(context, attributeSet),
    ...
    override fun onFinishInflate() {
        ...
        innerBinding = FavoriteInnerBinding(binding)
    }
